...
public class FinalBossPanel extends PluginPanel
{
    ...
    private final LfgPartiesPanel lfgPanel;
    private final LeaderboardPanel leaderboardPanel;

    private String activeTab = DROP_LOG_TAB;

    public FinalBossPanel(AnnouncementsPanel announcementsPanel, DropLogPanel dropLogPanel, LfgPartiesPanel lfgPanel, LeaderboardPanel leaderboardPanel)
    {
        super(false);
